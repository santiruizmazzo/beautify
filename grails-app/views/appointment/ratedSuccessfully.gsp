...
<html>
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row mb-3">
        <div class="col-lg-20">
          <g:link class="btn btn-outline-primary" controller="appointment" action="index">Mis turnos</g:link>
        </div>
      </div>
      
      <div class="row">
        <div class="col-lg-20">
          <h1>Turno calificado con exito ✅</h1>
        </div>
      </div>
